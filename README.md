...
![inserting a picture of the#
   landing image](documentation/landing.png)
...
![inserting a image of the footer](documentation/footer.png)
...
- ### About Page
  ...
  ![insert the second image of the About page](documentation/2nd.pic.about.png)

  ![insert the third picture of the About page](documentation/3rd.pic.about.png)
...
![insert picture of the Contact page](documentation/contact.png)
...
![image of the w3c validator, home page](documentation/w3c1.png)

![second image of the w3c validator, about page](documentation/w3c2.png)

![third image of the w3c validator, contact page](documentation/w3c3.png)
